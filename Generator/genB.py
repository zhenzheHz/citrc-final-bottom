...
# case 6 : not space
# case 7 : as statement
# score : 2 / 8 / 5 / 5 / 5 / 25 / 50

for test in range(2,100):
    if test < 10: generate_subtask2(test)
    elif test < 15: generate(test,space = False, limit_n = True, assign_n = 1)
    elif test < 20: generate(test,limit_n = True, assign_n = 1)
    elif test < 25: generate(test,space = False, limit_n = True, assign_n = 2)
    elif test < 50: generate(test,space = False)
    else: generate(test)